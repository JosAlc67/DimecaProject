"""Main entry point for the digital-prototype demo: robot state publisher,
mock ros2_control hardware, move_group, and RViz with the MotionPlanning
plugin.
...
def generate_launch_description():
    return generate_demo_launch(_moveit_config())
